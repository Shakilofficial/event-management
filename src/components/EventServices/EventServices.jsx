          ...
          <div className="">
              ...
              <div className="p-4 space-y-4 text-center mt-5">
                  ...
                  <div className='flex justify-between gap-5'>
                      <p className='flex justify-center items-center gap-3'> <FaPeopleGroup/> {attendance} </p>
                  ...
                  <div  className='flex justify-between items-center gap-5'>
                      <p className='flex justify-center items-center gap-3'> <FaDollarSign/> {price} </p>
                      <Link><button className='px-2 py-1 bg-rose-500 rounded-md text-white'>See Details</button></Link>
                  </div>
              </div>
      </div>
    </div>
